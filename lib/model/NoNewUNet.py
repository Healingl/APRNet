...
class NoNewUNet(BaseModel):
    """
    Implementations based on NoNewUNet: BraTS2017 3rd arxiv1802.10508
    """

    def __init__(self, in_channels, classes, base_n_filter=16):
        super(NoNewUNet, self).__init__()
